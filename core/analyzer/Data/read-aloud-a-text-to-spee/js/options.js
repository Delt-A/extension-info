...
function initialize(allVoices, settings) {
    ...
    $("#voices")
        ...
        .change(function() {
            ...
            if (voiceName == "@custom") brapi.tabs.create({
                url: "custom-voices.html"
            });
            else if (voiceName == "@premium") brapi.tabs.create({
                url: "premium-voices.html"
            });
            else saveSettings({
                voiceName: voiceName
            });
    ...
    $("[name=highlighting]")
        ...
        .change(function() {
            ...
            saveSettings({
                showHighlighting: Number($(this).val())
            });
        })
