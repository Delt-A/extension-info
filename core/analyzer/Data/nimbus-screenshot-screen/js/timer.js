...
var timerContent = (function() {
    ...
    function insert(tad_id, cb) {
        chrome.tabs.insertCSS(tad_id, {
            file: "css/timer.min.css"
        });

        chrome.tabs.executeScript(tad_id, {
            file: "js/lib/jquery-3.3.1.js"
        }, function() {
            chrome.tabs.executeScript(tad_id, {
                file: "js/progressbar.js"
            }, function() {
                chrome.tabs.executeScript(tad_id, {
                    file: "js/timer_content.js"
                }, function() {
                    cb && cb(tad_id);
                });
            });
