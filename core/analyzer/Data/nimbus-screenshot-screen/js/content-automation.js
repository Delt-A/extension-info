...
if (!window.EXT_AUTOMATION_JS_INSERTED) {
    ...
    chrome.runtime.sendMessage({
        operation: 'get_automation_setting'
    }, function(res) {
        // console.log(res)
        if (res.quick_capture_github !== 'false' && location.origin === 'https://github.com') {
        ...
        if (res.quick_capture_github === 'false' && res.quick_capture_github_welcome === 'true' && location.origin === 'https://github.com') {
            ...
            chrome.runtime.sendMessage({
                ...
                key: 'quickVideoCaptureGithubWelcome',
                value: 'false'
            });
        }
            ...
            if (req.operation === 'content_automation_send_url') {
                if (req.site && req.site === 'github') {
                    ...
                    copyTextToClipboard(req.url, function(err, message) {
                        ...
                        // setUploadBox(req.url + (!err ? '<br>' + message : ''));
                    });
