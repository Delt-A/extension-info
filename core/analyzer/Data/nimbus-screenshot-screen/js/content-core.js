...
window.core.blobUrlToBlob = function(dataURL, cb) {
    let xhr = new XMLHttpRequest();
    xhr.open("GET", dataURL, true);
    xhr.responseType = "arraybuffer";
    xhr.onload = function() {
...
window.core.sendAllMessage = function(data, cb) {
...
window.core.setActiveTab = function(tab) {
    console.log(tab)
...
window.core.customError = function(name, message) {
    let e = new Error();
    e.name = name;
    e.message = message;
    return e;
};
window.core.formatBytes = function(bytes, decimals = 2) {
...
window.core.getVideoFileName = function(info, format) {
...
window.core.getImageFileName = function(info, format) {
