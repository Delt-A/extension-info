    ...
    if (!window.thisFragment) {
        let captureFragment = {
            ...
            viewFragment: function(dataUrl, position) {
                ...
                if (position.w < 325) ns_crop_more.css({
                    'bottom': '0',
                    'top': 'auto'
                });
            ...
            viewBorder: function() {
                if (!$('.capture-fragment-border').length) {
                    $(document.body).append(
                        $('<div>', {
                            class: 'capture-fragment-border',
                            id: 'capture_fragment_border_top'
                        }),
                        $('<div>', {
                            class: 'capture-fragment-border',
                            id: 'capture_fragment_border_bottom'
                        }),
                        $('<div>', {
                            class: 'capture-fragment-border',
                            id: 'capture_fragment_border_left'
                        }),
                        $('<div>', {
                            class: 'capture-fragment-border',
                            id: 'capture_fragment_border_right'
                        })
                    );
                }
                $('#capture_fragment_border_top').css({
                    top: this.position.y,
                    left: this.position.x,
                    width: this.position.w,
                    height: this.border
                });
                $('#capture_fragment_border_bottom').css({
                    top: this.position.y + this.position.h - this.border,
                    left: this.position.x,
                    width: this.position.w,
                    height: this.border
                });
                $('#capture_fragment_border_left').css({
                    top: this.position.y,
                    left: this.position.x,
                    width: this.border,
                    height: this.position.h
                });
                $('#capture_fragment_border_right').css({
                    top: this.position.y,
                    left: this.position.x + this.position.w - this.border,
                    width: this.border,
                    height: this.position.h
                });
            },
