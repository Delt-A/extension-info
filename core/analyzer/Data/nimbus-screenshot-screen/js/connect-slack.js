...
window.slackShare = {
    data: null,
    login: function() {
        if (!localStorage.slackToken) chrome.runtime.sendMessage({
            operation: 'oauth_slack'
        });
    },
    logout: function() {
        localStorage.slackToken = null;
        window.core.setOption('slackToken', localStorage.slackToken);
