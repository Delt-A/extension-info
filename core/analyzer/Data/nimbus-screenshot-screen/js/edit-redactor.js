    ...
    $.fn.canvasPaint = function(method) {
        ...
        function Line() {
            ...
            this.getNumberPosition = function() {
                return {
                    x: this.x + this.number.x,
                    y: this.y + this.number.y - 25
                }
            };
        ...
        function ObCircle() {
            ...
            this.getNumberPosition = function() {
                return {
                    x: this.x - this.R + this.number.x - 10,
                    y: this.y - this.R / 2 + this.number.y
                }
            };
            this.remove = function(context) {
        ...
        function ObSticker() {
            ...
            this.getNumberPosition = function() {
                return {
                    x: this.x - this.w / 2 + this.number.x - 15,
                    y: this.y - this.h - 30 + this.number.y - 15
                }
            };
            this.remove = function(context) {
                var x1 = this.x - this.w / 2;
        ...
        function ObText() {
            ...
            this.createText = function() {
                if (textarea) {} else {
                    ...
                    if (this.shadow.enable) textarea.css({
                        textShadow: '1px 1px ' + this.shadow.blur + 'px ' + this.shadow.color
                    });
                    var _text = this;
                    textarea.blur(function(event) {
                        (function(v, s) {
        ...
        function ObTextArrow() {
            ...
            this.getNumberPosition = function() {
                return {
                    x: this.xb1 + this.number.x - 15,
                    y: this.yb1 + this.number.y - 15
                }
            };
            this.remove = function(context) {
                ...
                context.clearRect(x1 - 80, y1 - 80, x2 - x1 + 160, y2 - y1 + 160);
                context.clearRect(this.xb1, this.yb1, this.xb2 - this.xb1, this.yb2 - this.yb1);
        ...
        this.setWaterMark = function(dataURL, data, cb) {
            ...
            if (arguments.length >= 2) this.loadImageObject(dataURL, Object.assign(data, {
                watermark: true
            }), cb)
        };
        ...
        this.cropImage = function(data) {
            let w = Math.round(data.width / kzoom),
                h = Math.round(data.height / kzoom),
                x = Math.round(data.x / kzoom),
                y = Math.round(data.y / kzoom);
