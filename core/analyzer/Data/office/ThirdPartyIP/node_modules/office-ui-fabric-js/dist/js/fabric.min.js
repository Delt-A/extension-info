! function(e) {
    var t = function() {
        ...
        return e.transition = function(t, i) {
            ...
            e._animationObjects.push(s), e._parseProperties(s), e._createTransition(s), setTimeout(e._setProperties, 0, s), e._setCallback(s)
        }, e.animation = function(t, i, s) {
            var n = {
                element: t,
                keyframes: i,
                props: s
            };
            e._animationObjects.push(n), e._parseProperties(n), e._createAnimation(n), e._setCallback(n)
            ...
            e._setScrollProperties(s), s.props.delay ? setTimeout(e._animationObjects, 1e3 * s.props.delay, s) : e._animateScroll(s), e._animationObjects.push(s)
            ...
            for (var s in t.tweenObj = {}, t.props) e._contains(i, s) ? t[s] = t.props[s] : t.tweenObj[s] = t.props[s]
        }, e._animateScroll = function(t) {
            var i = t.props.duration / 33,
                s = e._easeOutExpo(t.step++, t.beginTop, t.change, i);
            t.element.scrollTop = s, t.step >= i ? (t.element.scrollTop = t.props.top, e._executeCallback(t.props), e._removeAnimationObject(t)) : setTimeout((function() {
            ...
            var i = t.duration || 0,
                s = t.delay || 0;
            t.element.style.transitionProperty = e._getTransitionProperties(t.tweenObj), t.element.style.transitionDuration = i.toString() + "s", t.element.style.transitionTimingFunction = t.ease || "linear", t.element.style.transitionDelay = s.toString() + "s"
            ...
            var i = !1,
                s = !1,
                n = [];
            for (var o in t) e._contains(e._transformProps, o) ? i = !0 : e._contains(e._filters, o) ? s = !0 : n.push(e._camelCaseToDash(o));
            return i && n.push("transform"), s && (n.push("-webkit-filter"), n.push("filter")), n.join(", ")
            ...
            var i = e.tweenObj[t]; - 1 === i.toString().indexOf("%") && (i += "opacity" !== t && "backgroundColor" !== t && "boxShadow" !== t ? "px" : ""), e.element.style[t] = i
        }, e._setFilterValues = function(t, i) {
            var s = t.tweenObj[i];
            s = "hueRotate" === i ? "(" + s + "deg)" : "blur" === i ? "(" + s + "px)" : "(" + s + "%)", i = e._camelCaseToDash(i), t.element.style.webkitFilter = i + s, t.element.style.filter = i + s
        ...
        }, e._easeOutExpo = function(e, t, i, s) {
...
function(e) {
    ...
    var t = function() {
        ...
        return e.prototype.removeOutlinesOnClick = function() {
            ...
            for (var e, t, i, s, n = this._listItems.length, o = 0; o < n; o++) t = (e = this._listItems[o].querySelector(".ms-Breadcrumb-itemLink")).textContent, i = e.getAttribute("href"), s = parseInt(e.getAttribute("tabindex"), 10), this._itemCollection.push({
                link: i,
                tabIndex: s,
                text: t
            })
            ...
            this._itemCollection.slice(0, i).forEach((function(e) {
                var i = document.createElement("li");
                i.className = "ms-ContextualMenu-item";
                var s = document.createElement("a");
                s.className = "ms-ContextualMenu-link", null !== e.link && s.setAttribute("href", e.link), s.setAttribute("tabindex", (t._tabIndex++).toString()), s.textContent = e.text, i.appendChild(s), t._contextMenu.appendChild(i)
            }))
...
function(e) {
    var t = "is-open",
        i = "is-positioned",
        s = "ms-ContextualHost-main",
        n = "ms-ContextualHost-beak",
        o = "ms-ContextualHost--",
        r = function() {
            function e(t, i, r, a, c, l, h) {
                if (void 0 === a && (a = !0), this._resizeAction = this._resizeAction.bind(this), this._dismissAction = this._dismissAction.bind(this), this._handleKeyUpDismiss = this._handleKeyUpDismiss.bind(this), this._matchTargetWidth = l || !1, this._direction = i, this._container = this.createContainer(), this._contextualHost = this._container, this._contextualHostMain = this._contextualHost.getElementsByClassName(s)[0], this._contextualHostMain.appendChild(t), this._hasArrow = a, this._arrow = this._container.getElementsByClassName(n)[0], this._targetElement = r, this._openModal(), this._setResizeDisposal(), h && (this._disposalCallback = h), c)
                    for (var d = 0; d < c.length; d++) this._container.classList.add(o + c[d]);
            ...
            return e.prototype.disposeModal = function() {
                ...
                t.setAttribute("class", s), t.innerHTML += " ", e.appendChild(t), e.innerHTML += " ";
                var i = document.createElement("div");
                return i.setAttribute("class", n), e.appendChild(i), e.innerHTML += "", e
            ...
            }, e.prototype._positionOk = function(e, t, i, s) {
                var n;
                return (n = e()) || !(n = t()) && i && (!(n = i()) && s && (n = s())), n
                ...
                var t, s, n, o, r = this._targetElement.getBoundingClientRect(),
                    a = r.left,
                    c = r.right,
                    l = r.top,
                    h = r.width,
                    d = r.height,
                    p = "",
                    _ = window.scrollX ? window.scrollX : 0,
                    u = window.scrollY ? window.scrollY : 0,
                    m = this._hasArrow ? 28 : 0;
                switch (this._matchTargetWidth && (p = "width: " + this._modalWidth + "px;"), e) {
                    case "left":
                        t = a - this._modalWidth - m, s = this._calcTop(this._modalHeight, d, l), s += window.scrollY ? window.scrollY : 0, this._container.setAttribute("style", "top: " + s + "px; left: " + t + "px;" + p), this._container.classList.add(i), this._hasArrow && (this._container.classList.add("ms-ContextualHost--arrowRight"), n = l + u - s + 8, this._arrow.setAttribute("style", "top: " + n + "px;"));
                        break;
                    case "right":
                        s = this._calcTop(this._modalHeight, d, l), s += u, t = c + m, this._container.setAttribute("style", "top: " + s + "px; left: " + t + "px;" + p), this._container.classList.add(i), this._hasArrow && (n = u + l - s + 8, this._arrow.setAttribute("style", "top: " + n + "px;"), this._container.classList.add("ms-ContextualHost--arrowLeft"));
                        break;
                    case "top":
                        t = this._calcLeft(this._modalWidth, this._teWidth, a), s = l - this._modalHeight - m, s += u, this._container.setAttribute("style", "top: " + s + "px; left: " + t + "px;" + p), this._container.classList.add(i), this._hasArrow && (n = this._modalHeight - m / 2, o = Math.max(_ + a - t + (h - m) / 2, 8), this._arrow.setAttribute("style", "top: " + n + "px; left: " + o + "px;"), this._container.classList.add("ms-ContextualHost--arrowBottom"));
                        break;
                    case "bottom":
                        t = t = this._calcLeft(this._modalWidth, this._teWidth, a), s = l + d + m, s += window.scrollY ? window.scrollY : 0, this._container.setAttribute("style", "top: " + s + "px; left: " + t + "px;" + p), this._container.classList.add(i), this._hasArrow && (o = Math.max(_ + a - t + (h - m) / 2, 8), this._arrow.setAttribute("style", "left: " + o + "px;"), this._container.classList.add("ms-ContextualHost--arrowTop"));
                        break;
                    default:
                ...
                if (this._container.setAttribute("style", "opacity: 0; z-index: -1"), this._container.classList.add(i), this._container.classList.add(t), this._matchTargetWidth) {
                    var s = window.getComputedStyle(this._targetElement);
                    this._modalWidth = this._targetElement.getBoundingClientRect().width + (parseInt(s.marginLeft, 10) + parseInt(s.marginLeft, 10))
...
var fabric, STATE_HIDDEN = "is-hidden",
    ...
    var t = function() {
        ...
        return t.prototype.removeListeners = function() {
            ...
            if (this._choiceFieldGroup.id === t) {
                for (var s = 0; s < this._choiceFieldComponents.length; s++) this._choiceFieldComponents[s].unCheck();
                i.check()
            }
        }, t
    }();
    ...
    var t = "has-text",
        ...
        s = function() {
            ...
            return e.prototype.setCollapsedListeners = function() {
                ...
                this._searchBox = e, this._searchBoxField = this._searchBox.querySelector(".ms-SearchBox-field"), this._searchBoxClearButton = this._searchBox.querySelector(".ms-SearchBox-clear"), this._searchBoxExitButton = this._searchBox.querySelector(".ms-SearchBox-exit")
                ...
                this._searchBoxField.addEventListener("focus", (function() {
                    t._setHasText(), t._searchBox.addEventListener("keyup", t._boundEnableClose, !1), t._searchBox.classList.add(i), t._searchBox.classList.add(i)
                }), !0)
...
function(e) {
    var t = ".ms-ContextualMenu",
        ...
        s = ".ms-CommandButton-button",
        n = function() {
            function n(e, n) {
                this._container = e, this._command = this._container, this._commandButton = this._command.querySelector(s), this._splitButton = this._command.querySelector(i), this._contextualMenu = n || this._container.querySelector(t), this._checkForMenu()
            }
            return n.prototype._createModalHostView = function() {
                this._modalHostView = new e.ContextualHost(this._contextualMenu, "bottom", this._command, !1)
            }, n.prototype._setClick = function() {
            ...
            }, n.prototype._checkForMenu = function() {
...
function(e) {
    "use strict";
    var t = ".ms-SearchBox",
        i = ".ms-CommandBar-mainArea",
        s = ".ms-CommandBar-sideCommands",
        n = ".ms-CommandBar-overflowButton",
        ...
        a = function() {
            ...
            return a.prototype._runsSearchBox = function(e) {
                void 0 === e && (e = "add"), this._changeSearchState("is-collapsed", e)
            }, a.prototype._runOverflow = function() {
            ...
            }, a.prototype._initOverflow = function() {
                this._createContextualRef(), this._createItemCollection(this.itemCollection, i), this._createItemCollection(this._sideAreaCollection, s), this._saveCommandWidths(), this._updateCommands(), this._drawCommands(), this._setWindowEvent(), this._checkOverflow()
            }, a.prototype._hasClass = function(e, t) {
                return (" " + e.className + " ").indexOf(" " + t + " ") > -1
            }, a.prototype._onSearchExpand = function() {
                "lg" === this.breakpoint && (this._container.classList.add("search-expanded"), this._doResize())
            }, a.prototype._onSearchCollapse = function() {
                "lg" === this.breakpoint && (this._container.classList.remove("search-expanded"), this._doResize())
            }, a.prototype._getScreenSize = function() {
                var e = window,
                    t = {
                        x: 0,
                        y: 0
                ...
                return t.x = e.innerWidth || s.clientWidth || n.clientWidth, t.y = e.innerHeight || s.clientHeight || n.clientHeight, t
            }, a.prototype._setBreakpoint = function() {
            ...
            }, a.prototype._createSearchInstance = function() {
                return !!this._elements.searchBox && new e.SearchBox(this._elements.searchBox)
            }, a.prototype._changeSearchState = function(e, t) {
                ...
                for (var h = 0; h < l.length; h++) {
                    ...
                    t.push({
                        ...
                        label: a,
                        icon: d,
                        isCollapsed: !!s.classList.contains(o),
                        commandButtonRef: new e.CommandButton(s)
                    })
                }
            }, a.prototype._createContextualRef = function() {
                this.contextualItemContainerRef = this._elements.contextMenu.querySelector(".ms-ContextualMenu-item").cloneNode(!0), this.contextualItemLink = this._elements.contextMenu.querySelector(".ms-ContextualMenu-link").cloneNode(!1), this.contextualItemIcon = this._elements.contextMenu.querySelector(".ms-Icon").cloneNode(!1), this._elements.contextMenu.innerHTML = ""
            }, a.prototype._getElementWidth = function(e) {
                var t, i;
            ...
            }, a.prototype._saveCommandWidths = function() {
            ...
            }, a.prototype._updateCommands = function() {
                var e = 0,
                ...
                for (var s = 0, n = 0; n < this.itemCollection.length; n++)(s += this.commandWidths[n]) < i ? this.visibleCommands.push(this.itemCollection[n]) : this.overflowCommands.push(this.itemCollection[n])
            }, a.prototype._drawCommands = function() {
                ...
                for (var e = 0; e < this.overflowCommands.length; e++) {
                    ...
                    var t = this.contextualItemContainerRef.cloneNode(!1),
                        ...
                        s = this.overflowCommands[e].icon;
                    if (i.innerText = this.overflowCommands[e].label, t.appendChild(i), s) {
                        var n = this.contextualItemIcon.cloneNode(!1);
                        n.className = r.replace(".", "") + " " + s, t.appendChild(n)
                    }
            ...
            }, a.prototype._setWindowEvent = function() {
                var e = this;
                window.addEventListener("resize", (function() {
                    e._doResize()
                }), !1)
            }, a.prototype._processCollapsedClasses = function(e) {
                for (var t = 0; t < this.itemCollection.length; t++) {
                    (i = this.itemCollection[t]).isCollapsed || ("add" === e ? i.item.classList.add(o) : i.item.classList.remove(o))
                }
                for (t = 0; t < this._sideAreaCollection.length; t++) {
                    var i;
                    (i = this._sideAreaCollection[t]).isCollapsed || ("add" === e ? i.item.classList.add(o) : i.item.classList.remove(o))
                }
            }, a.prototype._setUIState = function() {
            ...
            }, a.prototype._checkOverflow = function() {
            ...
            }, a.prototype._redrawMenu = function() {
                var e;
...
function(e) {
    var t = "bottom",
        i = function() {
            function i(e, i, s) {
                this._container = e, this._hostTarget = i, this._position = s || t, this._isOpen = !1, this._setOpener(i), this._init()
            }
            return i.prototype.getHost = function() {
                return this._host
            ...
            }, i.prototype._onDocumentClick = function(e) {
                if (e.target instanceof HTMLElement) {
                    var t = e.target,
                        i = t.classList;
                    this._hostTarget.contains(t) || i.contains("ms-ContextualMenu-link") || (this._isOpen = !1)
                }
            }, i.prototype._onContextualMenuClick = function(e) {
                var t = e.target,
                    i = t.classList;
            ...
            }, i.prototype._singleSelect = function(e) {
                for (var t = this._container.querySelectorAll(".is-selected"), i = t.length; i--;) t[i].classList.remove("is-selected");
                e.classList.add("is-selected")
            }, i.prototype._toggleMenu = function(e) {
                this._isOpen ? this._host.disposeModal() : this._openContextMenu(e), this._isOpen = !this._isOpen
            }, i.prototype._setOpener = function(e) {
                var t = this;
                e.addEventListener("click", (function(e) {
                    e.preventDefault(), t._toggleMenu(e)
                }))
            }, i.prototype._openContextMenu = function(e) {
                this._createModalHostView(this._container, this._position, this._hostTarget), this._checkForSubmenus(this._container)
            }, i.prototype._checkForSubmenus = function(t) {
                var i = this,
                    s = t.querySelectorAll(".ms-ContextualMenu-item.ms-ContextualMenu-item--hasMenu"),
                    n = s.length;
                if (s.length)
                    for (var o = function() {
                            var t = s[n].querySelector(".ms-ContextualMenu-link"),
                                o = s[n].querySelector(".ms-ContextualMenu");
                            if (o) {
                                var r = new e.ContextualMenu(o, t, "right");
                                o.addEventListener("hostAdded", (function() {
                                    i._host.setChildren(r.getHost())
                                }))
                            }
                        }; n--;) o()
            }, i.prototype._createModalHostView = function(t, i, s) {
                t.classList.remove("is-hidden"), this._host = new e.ContextualHost(t, i, s, !1);
                var n = document.createEvent("Event");
                n.initEvent("hostAdded", !0, !0), t.dispatchEvent(n)
            }, i
        }();
    e.ContextualMenu = i
}(fabric || (fabric = {})),
function(e) {
    var t = function() {
        function e(e, t) {
            var i = this,
                s = $(e),
                n = s.find(".ms-TextField-field").pickadate($.extend({
        ...
        return e.prototype.initCustomView = function(e) {
            var t = this,
                ...
                s = e.find(".ms-DatePicker-goToday"),
                n = e.find(".ms-DatePicker-monthPicker"),
                o = e.find(".ms-DatePicker-yearPicker"),
                r = e.find(".ms-DatePicker-wrap"),
                a = e.find(".ms-TextField-field").pickadate("picker");
            i.appendTo(r), s.appendTo(r), n.appendTo(r), o.appendTo(r), this.updateCustomView(e), a.on("open", (function(e) {
                ...
                var i = a.get("highlight").month + 1;
                t.changeHighlightedDate([null, i, null])
            })), n.on("click", ".js-prevYear", (function(e) {
                e.preventDefault();
                var i = a.get("highlight").year - 1;
                t.changeHighlightedDate([i, null, null])
            })), n.on("click", ".js-nextYear", (function(e) {
                e.preventDefault();
                var i = a.get("highlight").year + 1;
                t.changeHighlightedDate([i, null, null])
            ...
            })), n.on("click", ".js-changeDate", (function(i) {
                i.preventDefault();
                var s = $(i.target),
                    n = s.attr("data-year"),
                    o = s.attr("data-month"),
                    r = s.attr("data-day");
                t.changeHighlightedDate([n, o, r]), e.hasClass("is-pickingMonths") && e.removeClass("is-pickingMonths")
                ...
                var s = $(i.target),
                    ...
                    o = s.attr("data-month"),
                    r = s.attr("data-day");
                t.changeHighlightedDate([n, o, r]), e.hasClass("is-pickingYears") && e.removeClass("is-pickingYears")
            })), n.on("click", ".js-showDayPicker", (function() {
            ...
            })), n.on("click", ".js-showYearPicker", (function() {
            ...
            t.find(".ms-DatePicker-currentYear").text(s.get("view").year), t.find(".ms-DatePicker-monthOption").removeClass("is-highlighted"), t.find(".ms-DatePicker-monthOption[data-month='" + s.get("highlight").month + "']").addClass("is-highlighted"), i.find(".ms-DatePicker-currentDecade").remove(), i.find(".ms-DatePicker-optionGrid").remove();
            var n = s.get("highlight").year - 11,
                o = "<div class='ms-DatePicker-currentDecade'>" + (n + " - " + (n + 11)) + "</div>";
            o += "<div class='ms-DatePicker-optionGrid'>";
            for (var r = n; r < n + 12; r++) o += "<span class='ms-DatePicker-yearOption js-changeDate' data-year='" + r + "'>" + r + "</span>";
            o += "</div>", i.append(o), i.find(".ms-DatePicker-yearOption").removeClass("is-highlighted"), i.find(".ms-DatePicker-yearOption[data-year='" + s.get("highlight").year + "']").addClass("is-highlighted")
        }, e.prototype.setDateAttributes = function(e) {
            var t = e[0],
                i = e[1],
                s = e[2];
            return null != t || (t = this.picker.get("highlight").year), null != i || (i = this.picker.get("highlight").month), null != s || (s = this.picker.get("highlight").date), [t, i, s]
        }, e
    }();
    e.DatePicker = t
}(fabric || (fabric = {})),
...
function(e) {
    var t = function() {
        ...
        return t.prototype.dismiss = function() {
            ...
            this.panelHost = document.createElement("div"), this.panelHost.classList.add("ms-PanelHost"), this.panelHost.appendChild(this._layer), this.overlay = new e.Overlay(this._overlayContainer), this.overlay.show(), this.panelHost.appendChild(this.overlay.overlayElement)
        }, t
    }();
    e.PanelHost = t
}(fabric || (fabric = {})),
    ...
    var t = "animate-in",
        ...
        s = function() {
            ...
            return s.prototype.dismiss = function(e) {
                ...
                }), 400), null !== this._closeButton && this._closeButton.removeEventListener("click", this._clickHandler)
...
function(e) {
    var t = "ms-Dropdown",
        ...
        h = function() {
            function h(e) {
                this._container = e, this._dropdownLabelHelper = document.createElement("span"), this._dropdownLabelHelper.classList.add(s), this._dropdownLabelHelper.classList.add(i), this._newDropdownLabel = document.createElement("span"), this._newDropdownLabel.classList.add(i), this._newDropdown = document.createElement("ul"), this._newDropdown.classList.add(n), this._dropdownItems = [], this._originalDropdown = e.querySelector(r);
                ...
                for (var a = 0; a < t.length; ++a) {
                    var h = t[a];
                    h.selected && (this._newDropdownLabel.innerHTML = h.text);
                    var d = document.createElement("li");
                    d.classList.add(o), h.disabled && d.classList.add(c), h.selected && d.classList.add(l), d.innerHTML = h.text, d.addEventListener("click", this._onItemSelection), this._newDropdown.appendChild(d), this._dropdownItems.push({
                        oldOption: h,
                        newItem: d
                    })
                }
            ...
            return h.prototype._setWindowEvent = function() {
                var e = this;
                window.addEventListener("resize", (function() {
                    e._doResize(), e._checkTruncation()
                }), !1)
            }, h.prototype._checkTruncation = function() {
                var e = this._newDropdown.querySelector("." + l),
                ...
                if (this._dropdownLabelHelper.textContent = t, this._dropdownLabelHelper.offsetHeight > this._newDropdownLabel.offsetHeight) {
                    var i = 0,
                        s = void 0;
                    do {
                        i--, s = t.slice(0, i), this._dropdownLabelHelper.textContent = s + "..."
            ...
            }, h.prototype._getScreenSize = function() {
                var e = window,
                    t = {
                        x: 0,
                        y: 0
                    ...
                    n = i.getElementsByTagName("body")[0];
                return t.x = e.innerWidth || s.clientWidth || n.clientWidth, t.y = e.innerHeight || s.clientHeight || n.clientHeight, t
            }, h.prototype._doResize = function() {
                this._container.classList.contains(a) && (this._getScreenSize().x <= 479 ? this._openDropdownAsPanel() : this._removeDropdownAsPanel())
            }, h.prototype._openDropdownAsPanel = function() {
            ...
            }, h.prototype._removeDropdownAsPanel = function(e) {
                var t = this;
            ...
            }, h.prototype._onOpenDropdown = function(e) {
                var t = this._container.classList.contains(c),
                    i = this._container.classList.contains(a);
                t || i || (e.stopPropagation(), this._closeOtherDropdowns(), this._container.classList.add(a), document.addEventListener("click", this._onCloseDropdown), this._getScreenSize().x <= 479 && this._openDropdownAsPanel())
            }, h.prototype._closeOtherDropdowns = function() {
                for (var e = document.querySelectorAll("." + t + "." + a), i = 0; i < e.length; i++) e[i].classList.remove(a)
            }, h.prototype._onCloseDropdown = function(e) {
                this._removeDropdownAsPanel(e), this._container.classList.remove(a), document.removeEventListener("click", this._onCloseDropdown)
            }, h.prototype._onItemSelection = function(e) {
                var t = e.target,
                    i = this._container.classList.contains(c),
                    s = t.classList.contains(c);
                if (!i && !s) {
                    for (var n = 0; n < this._dropdownItems.length; ++n) this._dropdownItems[n].newItem === t ? (this._dropdownItems[n].newItem.classList.add(l), this._dropdownItems[n].oldOption.selected = !0) : (this._dropdownItems[n].newItem.classList.remove(l), this._dropdownItems[n].oldOption.selected = !1);
...
function(e) {
    var t = function() {
        ...
        return t.prototype.removeListeners = function() {
            ...
            i && -1 === t.className.indexOf("is-active") && (this._setAction(t), this._setDetail(i))
        }, t.prototype._setAction = function(e) {
            this._container.querySelector(".ms-PersonaCard-action.is-active").classList.remove("is-active"), e.classList.add("is-active")
            ...
            var t = ".ms-PersonaCard-details[data-detail-id='" + e + "']",
                ...
                s = this._container.querySelector(t);
            i && i.classList.remove("is-active"), s.classList.add("is-active");
...
function(e) {
    var t = function() {
        ...
        return t.prototype._createPersonaCard = function() {
            this._personaCardInstance = new e.PersonaCard(this._personaCard)
        }, t.prototype._createContextualHostInstance = function() {
            this._personaCard.setAttribute("style", "display: block;"), this._contextualHostInstance = new e.ContextualHost(this._personaCard, "top", this._persona)
...
function(e) {
    var t = ".ms-Persona-image",
        i = ".ms-Persona-primaryText",
        s = ".ms-Persona-secondaryText",
        n = function() {
            function n(e) {
                this._personaCollection = [], this._facePile = e, this._createPersonaCollection()
            }
            return n.prototype._createPersonaCollection = function() {
                for (var n = document.querySelectorAll(".ms-Persona--facePile"), o = 0; o < n.length; o++) {
                    var r = n[o];
                    this._personaCollection.push({
                        item: r,
                        initials: r.querySelector(".ms-Persona-initials").textContent,
                        image: r.querySelector(t) ? r.querySelector(t).getAttribute("src") : null,
                        primaryText: r.querySelector(i) ? r.querySelector(i).textContent : "",
                        secondaryText: r.querySelector(s) ? r.querySelector(s).textContent : "",
                        personaInstance: new e.Persona(r)
                    })
                }
            }, n
        }();
...
function(e) {
    var t = function(t) {
        ...
        for (var i = this._container.querySelectorAll(".ms-ListItem"), s = 0; s < i.length; s++) this._listItemComponents[s] = new e.ListItem(i[s])
    };
    e.List = t
}(fabric || (fabric = {})),
function(e) {
    ...
    var t = function() {
        ...
        return e.prototype.init = function() {
            ...
            -1 === this._errorBanner.className.indexOf("hide") && (this._errorBanner.className += " hide", setTimeout(this._hideMessageBanner.bind(this), 500))
...
function(e) {
    var t = function() {
        ...
        return t.prototype._createModalHost = function(t) {
            t.stopPropagation(), this._peoplePickerMenu.setAttribute("style", "display: block;"), this._contextualHostView = new e.ContextualHost(this._peoplePickerMenu, "bottom", this._peoplePickerSearchBox, !1, [""], !0, this._contextHostCallBack.bind(this)), this._peoplePickerSearchBox.classList.add("is-active"), this._isContextualMenuOpen = !0
        }, t.prototype._clickHandler = function(e) {
            this._createModalHost(e);
            var t = this._peoplePickerMenu.querySelector(".ms-PeoplePicker-result").parentNode,
                i = t.cloneNode(!0);
            t.parentNode.replaceChild(i, t), this._peoplePickerResults = this._peoplePickerMenu.querySelectorAll(".ms-PeoplePicker-result");
            for (var s = 0; s < this._peoplePickerResults.length; s++) {
                var n = this._peoplePickerResults[s].querySelector(".ms-Persona"),
                    o = this._peoplePickerResults[s].querySelector(".ms-PeoplePicker-resultAction");
                n.addEventListener("click", this._selectResult.bind(this), !0), o.addEventListener("click", this._removeItem.bind(this), !0)
            }
        }, t.prototype._selectResult = function(e) {
            e.stopPropagation();
            var t = this._findElement(e.target, "ms-Persona").cloneNode(!0);
            this._container.classList.contains("ms-PeoplePicker--facePile") ? this._addResultToMembers(t) : this._tokenizeResult(t), this._updateCount(), this._contextualHostView.disposeModal()
            ...
            var t = this._container.querySelector(".ms-PeoplePicker-searchBox"),
                i = t.querySelector(".ms-TextField");
            e.classList.add("ms-Persona--token", "ms-PeoplePicker-persona"), this._addRemoveBtn(e, !0), e.classList.contains("ms-Persona--sm") && (e.classList.remove("ms-Persona--sm"), e.classList.add("ms-Persona--xs")), t.insertBefore(e, i)
            ...
            s.classList.add("ms-PeoplePicker-selectedPerson"), s.tabIndex = 1, s.appendChild(e), this._addRemoveBtn(s, !1), s.querySelector(".ms-PeoplePicker-resultAction").addEventListener("click", this._removeResult.bind(this), !0), t.insertBefore(s, i)
    ...
    var t = function() {
        ...
        return e.prototype.removeListeners = function() {
            ...
            if (e.classList.contains("ms-Pivot-link") && !e.querySelector(".ms-Pivot-ellipsis")) {
                ...
                var s = e.getAttribute("data-content");
                this._container.querySelector(".ms-Pivot-content[data-content='" + s + "']").style.display = "block"
            }
    ...
    var t = function(e, t) {
        ...
        i = function() {
            ...
            return e.prototype.start = function() {
                ...
                -1 === this._target.className.indexOf("ms-Spinner") ? (this.spinner = document.createElement("div"), this.spinner.className = "ms-Spinner", this._target.appendChild(this.spinner)) : this.spinner = this._target
            }, e.prototype._initializeOpacities = function() {
                var e, t = 0,
                    i = 1;
                for (this.fadeIncrement = 1 / this.numCircles; t < this.numCircles; t++) {
                    var s = this.circleObjects[t];
                    e = this.fadeIncrement * i++, this._setOpacity(s.element, e)
                }
                ...
                for (var e, i = 0, s = this.parentSize * this.offsetSize, n = 2 * Math.PI / this.numCircles, o = this.numCircles, r = .5 * (this.parentSize - s); o--;) {
                    var a = this._createCircle(),
                        c = Math.round(.5 * this.parentSize + r * Math.cos(i) - .5 * a.clientWidth) - .5 * s,
                        l = Math.round(.5 * this.parentSize + r * Math.sin(i) - .5 * a.clientHeight) - .5 * s;
                    this.spinner.appendChild(a), a.style.left = c + "px", a.style.top = l + "px", i += n, e = new t(a, o), this.circleObjects.push(e)
                }
            }, e
        }();
    e.Spinner = i
