    ...
    function Tiles() {
        ...
        this.drawShape = function(color, r, c, type, addFill, boxSize) {
            ...
            if (type == 0) { //remove box
                ...
                if (addFill == true && color != "#ffffff") {
                    shape.graphics.beginFill("#ffffff").drawRect(0, 0, box, box);
                }
                ...
                if (addFill == true) {
                    color = "#0286f2";
                    shape.graphics.beginFill("#ffffff").drawRect(box * 0.2, box * 0.2, box * 0.6, box * 0.6);
                }
                shape.graphics.beginFill(color).drawRect(0, 0, box, box * 0.2);
                shape.graphics.beginFill(color).drawRect(box * 0.8, box * 0.2, box * 0.2, box * 0.6);
                shape.graphics.beginFill(color).drawRect(0, box * 0.8, box, box * 0.2);
                ...
                if (addFill == true) {
                    color = "#0286f2";
                    shape.graphics.beginFill("#ffffff").drawRect(box * 0.125, box * 0.125, box * 0.875, box * 0.875);
                }
