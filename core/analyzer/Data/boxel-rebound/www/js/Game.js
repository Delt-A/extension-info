(function(window) {
    ...
    function Game() {
        ...
        this.setStage = function() {
            ...
            switch (this.view) {
                ...
                case (1):
                    ...
                    break;
                case (2):
                    this.artboard.addChild(this.theme, this.levelMap, this.player, this.particles);
                    break;
                case (3):
        ...
        this.stageMouseDown = function(event) {
            if (this.view == 0) {} else if (this.view == 1) {} else if (this.view == 2) {
                this.player.jump();
            } else if (this.view == 3) {
        ...
        this.stageMouseMove = function(event) {
            if (this.view == 0) {} else if (this.view == 1) {} else if (this.view == 2) {} else if (this.view == 3) {
        ...
        this.pauseGame = function() {
            if (this.view == 1) {
                /*intro screen*/ } else if (this.view == 2) { //game pause setting
                if (this.gamePaused == false) {
