(function(window) {
    ...
    function Button(text, x, y, width, height, bgColor1, bgColor2, fontColor1, fontColor2, shapeInner) {
        ...
        this.setFontSize = function(fontSize) {
            this.fontSize = this.box16 * fontSize;
            this.redraw();
        };
        ...
        this.disable = function(alpha) {
            if (alpha == null) {
                alpha = 1;
            }
            this.mouseEnabled = false;
            this.content.alpha = alpha;
            this.shapeInner.alpha = alpha;
        };
        this.enable = function(alpha) {
        ...
        this.setText = function(text) {
            this.content.text = this.text = text;
        };
            ...
            if (this.isChar == true) { //only transform chars
                switch (style.toLowerCase()) {
                    ...
                    case ("lowercase"):
                        ...
                        break;
                    case ("capitalize"):
                        this.setText(window.lb.capitalize(text));
                        break;
                }
            }
        };
        ...
        this.setShapeAlpha = function(a) {
            this.shape.alpha = this.targetShapeAlpha = a;
        }
