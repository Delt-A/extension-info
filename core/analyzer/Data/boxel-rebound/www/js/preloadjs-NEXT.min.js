...
this.createjs = this.createjs || {},
    function() {
        ...
        a.version = "NEXT", a.buildDate = "Wed, 11 Jan 2017 23:28:23 GMT"
    ...
    function() {
        ...
        var a = createjs.extend(AbstractLoader, createjs.EventDispatcher),
            b = AbstractLoader;
        b.POST = createjs.Methods.POST, b.GET = createjs.Methods.GET, b.BINARY = createjs.Types.BINARY, b.CSS = createjs.Types.CSS, b.FONT = createjs.Types.FONT, b.FONTCSS = createjs.Types.FONTCSS, b.IMAGE = createjs.Types.IMAGE, b.JAVASCRIPT = createjs.Types.JAVASCRIPT, b.JSON = createjs.Types.JSON, b.JSONP = createjs.Types.JSONP, b.MANIFEST = "manifest", b.SOUND = createjs.Types.SOUND, b.VIDEO = createjs.Types.VIDEO, b.SPRITESHEET = createjs.Types.SPRITESHEET, b.SVG = createjs.Types.SVG, b.TEXT = createjs.Types.TEXT, b.XML = createjs.Types.XML, a.getItem = function() {
            return this._item
            ...
            return createjs.URLUtils.buildURI(a, b)
        }, a.toString = function() {
    ...
    function() {
        ...
        XHRRequest.ACTIVEX_VERSIONS = ["Msxml2.XMLHTTP.6.0", "Msxml2.XMLHTTP.5.0", "Msxml2.XMLHTTP.4.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], a.getResult = function(a) {
            ...
            return a >= 400 && 599 >= a ? new Error(a) : null
            ...
            var i = null;
            if (i = a.method == createjs.AbstractLoader.GET ? createjs.URLUtils.buildURI(a.src, a.values) : a.src, d.open(a.method || createjs.AbstractLoader.GET, i, !0), b && d instanceof XMLHttpRequest && 1 == this._xhrLevel && (c.Origin = location.origin), a.values && a.method == createjs.AbstractLoader.POST && (c["Content-Type"] = "application/x-www-form-urlencoded"), b || c["X-Requested-With"] || (c["X-Requested-With"] = "XMLHttpRequest"), a.headers)
    ...
    function() {
        ...
        }, b.loadTimeout = 8e3, b.LOAD_TIMEOUT = 0, b.BINARY = createjs.AbstractLoader.BINARY, b.CSS = createjs.AbstractLoader.CSS, b.FONT = createjs.AbstractLoader.FONT, b.FONTCSS = createjs.AbstractLoader.FONTCSS, b.IMAGE = createjs.AbstractLoader.IMAGE, b.JAVASCRIPT = createjs.AbstractLoader.JAVASCRIPT, b.JSON = createjs.AbstractLoader.JSON, b.JSONP = createjs.AbstractLoader.JSONP, b.MANIFEST = createjs.AbstractLoader.MANIFEST, b.SOUND = createjs.AbstractLoader.SOUND, b.VIDEO = createjs.AbstractLoader.VIDEO, b.SVG = createjs.AbstractLoader.SVG, b.TEXT = createjs.AbstractLoader.TEXT, b.XML = createjs.AbstractLoader.XML, b.POST = createjs.AbstractLoader.POST, b.GET = createjs.AbstractLoader.GET, a.registerLoader = function(a) {
    ...
    function() {
        ...
        function CSSLoader(a, b) {
            this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.CSS), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "href", this._tag = b ? createjs.Elements.style() : createjs.Elements.link(), this._tag.rel = "stylesheet", this._tag.type = "text/css"
        }
    ...
    function() {
        ...
        FontLoader.canLoadItem = function(a) {
            return a.type == createjs.AbstractLoader.FONT || a.type == createjs.AbstractLoader.FONTCSS
            ...
            this._stopWatching(), this.dispatchEvent(new createjs.ErrorEvent("PRELOAD_TIMEOUT", null, event))
        }, a._createRequest = function() {
    ...
    function() {
        ...
        function JavaScriptLoader(a, b) {
            this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.JAVASCRIPT), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "src", this.setTag(createjs.Elements.script())
        }
    ...
    function() {
        ...
        function JSONPLoader(a) {
            this.AbstractLoader_constructor(a, !1, createjs.AbstractLoader.JSONP), this.setTag(createjs.Elements.script()), this.getTag().type = "text/javascript"
        }
    ...
    function() {
        ...
        function SoundLoader(a, b) {
            this.AbstractMediaLoader_constructor(a, b, createjs.AbstractLoader.SOUND), createjs.DomUtils.isAudioTag(a) ? this._tag = a : createjs.DomUtils.isAudioTag(a.src) ? this._tag = a : createjs.DomUtils.isAudioTag(a.tag) && (this._tag = createjs.DomUtils.isAudioTag(a) ? a : a.src), null != this._tag && (this._preferXHR = !1)
        }
    ...
    function() {
        ...
        function VideoLoader(a, b) {
            this.AbstractMediaLoader_constructor(a, b, createjs.AbstractLoader.VIDEO), createjs.DomUtils.isVideoTag(a) || createjs.DomUtils.isVideoTag(a.src) ? (this.setTag(createjs.DomUtils.isVideoTag(a) ? a : a.src), this._preferXHR = !1) : this.setTag(this._createTag())
        }
    ...
    function() {
        ...
        function SVGLoader(a, b) {
            this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.SVG), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "data", b ? this.setTag(createjs.Elements.svg()) : (this.setTag(createjs.Elements.object()), this.getTag().type = "image/svg+xml")
        }
        ...
        b.canLoadItem = function(a) {
            ...
            var b = createjs.DataUtils.parseXML(a.getResult(!0)),
                c = a.getTag();
            return !this._preferXHR && document.body.contains(c) && document.body.removeChild(c), null != b.documentElement ? (c.appendChild(b.documentElement), c) : b
