    ...
    function Home() {
        ...
        this.setTheme = function(selectedLevel) {
            ...
            switch (Math.floor((selectedLevel) / this.rows)) {
                case (0):
                    updateUI = window.Game.theme.setTheme("pinkLand");
                    break;
                case (1):
                    updateUI = window.Game.theme.setTheme("darkLand");
                    break;
                case (2):
                    updateUI = window.Game.theme.setTheme("blueLand");
                    break;
                case (3):
                    updateUI = window.Game.theme.setTheme("hellLand");
                    break;
                case (4):
                    updateUI = window.Game.theme.setTheme("jungleLand");
                    break;
            }
