    ...
    function LevelEditor() {
        ...
        this.tick = function(delta) {
            ...
            if (this.screen == 1) {
                if (this.back_button.isClicked()) {
                    ...
                    /*temporarily no use*/ } else if (this.share_button_1.isClicked()) {
                    window.Game.dialog.openDialogWindow("downloadOptions");
                } else if (this.remove_button_1.isClicked()) {
                    this.deleteKey();
                ...
                if (this.menu_button.isClicked()) {
                ...
                } else if (this.share_button_2.isClicked()) {
                    window.Game.dialog.openDialogWindow("uploadOptions");
                } else if (this.undo_button.isClicked()) {
                    this.undo();
                } else if (this.redo_button.isClicked()) {
                    this.redo();
                    ...
                    createjs.Tween.get(window.Game.levelMap, {
                            override: true
                        })
                        .to({
                            x: this.xPos
                        ...
                        .call(function(tween) {
                            tween._target.parent.scrollSpeed = 0;
                        });
        ...
        this.renderEditorScreen = function() {
            ...
            if (this.showTileOptions) {
                ...
                this.tile0 = new Button("+0", leftX, bottomY - (bigBox), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile0.setShapeAlpha(a); //remove
                this.tile1 = new Button("+1", leftX + (bigBox), bottomY - (bigBox), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile1.setShapeAlpha(a); //normal
                this.tile2 = new Button("+2", leftX + (bigBox * 2), bottomY - (bigBox), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile2.setShapeAlpha(a); //tip
                this.tile3 = new Button("+3", leftX + (bigBox * 3), bottomY - (bigBox), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile3.setShapeAlpha(a); //spawn
                this.tile4 = new Button("+4", leftX, bottomY - (bigBox * 2), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile4.setShapeAlpha(a); //upSpike
                this.tile5 = new Button("+5", leftX + (bigBox), bottomY - (bigBox * 2), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile5.setShapeAlpha(a); //rightSpike
                this.tile6 = new Button("+6", leftX + (bigBox * 2), bottomY - (bigBox * 2), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile6.setShapeAlpha(a); //downSpike
                this.tile7 = new Button("+7", leftX + (bigBox * 3), bottomY - (bigBox * 2), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile7.setShapeAlpha(a); //leftSpike
                this.tile8 = new Button("+8", leftX, bottomY - (bigBox * 3), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile8.setShapeAlpha(a); //expandBox
                this.tile9 = new Button("+9", leftX + (bigBox), bottomY - (bigBox * 3), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile9.setShapeAlpha(a); //shrinkBox
                this.tile10 = new Button("+10", leftX + (bigBox * 2), bottomY - (bigBox * 3), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile10.setShapeAlpha(a); //bounceUp
                this.tile11 = new Button("+11", leftX + (bigBox * 3), bottomY - (bigBox * 3), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile11.setShapeAlpha(a); //finish
                this.tile12 = new Button("+12", leftX, bottomY - (bigBox * 4), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile12.setShapeAlpha(a); //up block
                this.tile13 = new Button("+13", leftX + (bigBox), bottomY - (bigBox * 4), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile13.setShapeAlpha(a); //right block
                this.tile14 = new Button("+14", leftX + (bigBox * 2), bottomY - (bigBox * 4), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile14.setShapeAlpha(a); //bottom block
                this.tile15 = new Button("+15", leftX + (bigBox * 3), bottomY - (bigBox * 4), bigBox, bigBox, this.main_color2, this.main_color3, "#ffffff", "#ffffff");
                this.tile15.setShapeAlpha(a); //left block
        ...
        this.stageMouseMove = function(event) {
            if (this.screen == 1) {
                ...
                if (this.levelButtons.y > 0) {
                    this.levelButtons.y = 0;
                }
            } else if (this.screen = 2) {
                if (this.mapDrag) {
                    this.setTile(event, true);
                }
            }
        };
        this.stageMouseUp = function(event) {
            if (this.screen == 1) {} else if (this.screen = 2) {
                this.setTile(event);
        ...
        this.deleteLevelButton = function() {
            ...
            if (index >= 0 && index < this.levelButtons.children.length) {
                ...
                if (this.levelButtons.children.length > 0) {
                    this.selectedButtonIndex--;
                }
            }
        };
        this.getLevelButtonText = function(i) {
            return this.levelButtons.getChildAt(i).getText();
        };
        ...
        this.resetEditorScreen = function(resumeEditing) {
            if (resumeEditing == true) {
                ...
                this.xPos = window.Game.levelMap.x = 0;
            }
        };
        ...
        this.checkSelectedTile = function() {
            switch (this.tileType) {
                case (0):
                    this.tile0.toggleColor(true);
                    break;
                case (1):
                    this.tile1.toggleColor(true);
                    break;
                case (2):
                    this.tile2.toggleColor(true);
                    break;
                case (3):
                    this.tile3.toggleColor(true);
                    break;
                case (4):
                    this.tile4.toggleColor(true);
                    break;
                case (5):
                    this.tile5.toggleColor(true);
                    break;
                case (6):
                    this.tile6.toggleColor(true);
                    break;
                case (7):
                    this.tile7.toggleColor(true);
                    break;
                case (8):
                    this.tile8.toggleColor(true);
                    break;
                case (9):
                    this.tile9.toggleColor(true);
                    break;
                case (10):
                    this.tile10.toggleColor(true);
                    break;
                case (11):
                    this.tile11.toggleColor(true);
                    break;
                case (12):
                    this.tile12.toggleColor(true);
                    break;
                case (13):
                    this.tile13.toggleColor(true);
                    break;
                case (14):
                    this.tile14.toggleColor(true);
                    break;
                case (15):
                    this.tile15.toggleColor(true);
                    break;
            }
        };
        ...
        this.undo = function() {
            this.hideTileOptions();
            window.Game.levelMap.undoMapHistory();
        };
        this.redo = function() {
            this.hideTileOptions();
            window.Game.levelMap.redoMapHistory();
        };
