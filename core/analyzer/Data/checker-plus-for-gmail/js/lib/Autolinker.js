...
(function(root, factory) {
    ...
    Autolinker.prototype = {
        ...
        parse: function(textOrHtml) {
            ...
            if (!this.hashtag) matches = matches.filter(function(match) {
                return match.getType() !== 'hashtag';
            });
            if (!this.email) matches = matches.filter(function(match) {
                return match.getType() !== 'email';
            });
            if (!this.phone) matches = matches.filter(function(match) {
                return match.getType() !== 'phone';
            });
            if (!this.twitter) matches = matches.filter(function(match) {
