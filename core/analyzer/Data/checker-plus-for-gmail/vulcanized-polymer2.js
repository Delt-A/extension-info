...
const IronValidatableBehavior = {
    ...
    validate: function(value) {
        ...
        if (value === undefined && this.value !== undefined) this.invalid = !this._getValidity(this.value);
